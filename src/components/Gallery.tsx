...
const Item: React.FC<ItemProps> = ({ item }) => {
    ...
    const textOverlayStyle: CSSProperties = {
        ...
        background:
            "linear-gradient(90deg, rgba(0, 0, 0, 0),rgba(0, 0, 0, 0.01),rgba(0, 0, 0, 0.05),rgba(0, 0, 0, 0.05),rgba(0, 0, 0, 0.05),rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.05),rgba(0, 0, 0, 0.01),rgba(0, 0, 0, 0)",
        color: "#fff",
        padding: "10px",
        textAlign: "center",
        width: "100%",
