...
const Gallery = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      DETAIL: 'Landing Page',
      TECHNOLOGIES: [pics.JS, pics.PG, pics.API, pics.REACT, pics.RX, pics.NODE, pics.EX, pics.CSS]
    },
    {
    ...
    },
    {
      ...
      TECHNOLOGIES: [pics.JS, pics.REACT, pics.CSS, pics.NODE, pics.EX, pics.API]
    },
    {
